...
public interface ProjectApi {
    ...
    @ApiOperation(value = "create a new project", notes = "", response = Void.class, authorizations = {
    ...
    ResponseEntity<Object> addproject(@ApiParam(value = "Project description to create" ,required=true )  @Valid @RequestBody Project body);
